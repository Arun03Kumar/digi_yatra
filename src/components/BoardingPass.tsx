...
const BoardingPass = ({ passenger, flight, onClose }: any) => {
  if (!passenger) return null;

  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center z-50">
      <div className="bg-white max-w-4xl mx-auto border-2 border-gray-300 rounded shadow-lg p-4 relative">
        ...
        <h2 className="text-xl font-bold text-red-600 mb-4 text-center">
          Boarding Pass Issued{" "}
          <span className="text-sm text-gray-600">(Final Approval Pending)</span>
        </h2>

        <div className="border border-gray-300 rounded p-4 bg-white">
          <div className="flex justify-between items-center border-b border-gray-300 pb-2">
            <div className="font-bold text-lg">Boarding Pass (Web Check-In)</div>
            <div className="text-sm text-blue-600 font-semibold">Your Departure Terminal is T1</div>
          </div>
        ...
        <div className="flex justify-between mt-4">
          <button onClick={onClose} className="p-2 bg-gray-400 text-white rounded">
            Close
          </button>
          <button onClick={() => window.print()} className="p-2 bg-black text-white rounded">
            Print
          </button>
        </div>
      </div>
